        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BuildingName = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: false),
            ...
            migrationBuilder.Sql(@"
                CREATE VIEW V_INSPECTION_SATISFACTORY AS
            ...
            ");
            migrationBuilder.Sql(@"
            CREATE VIEW V_INSPECTION_UNSATISFACTORY AS
                SELECT A.ID, A.Description, D.BuildingName, B.TypeName, A.Date, C.StatusName
               FROM Inspections A
                INNER JOIN InspectionTypes B ON A.InspectionTypeID = B.ID
                INNER JOIN Statuses C ON A.StatusID = C.ID
            ...
            migrationBuilder.Sql(@"
            CREATE VIEW V_SATISFACTORYTOP AS
            ...
            migrationBuilder.Sql(@"
            CREATE VIEW V_UNSATISFACTORYTOP AS
